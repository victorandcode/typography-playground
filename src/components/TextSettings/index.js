        ...
        return (
            <div className="TextSettings">
                ...
                <div className="TextSettings-formGroup">
                    <label className="TextSettings-formGroupColumn" htmlFor="text">Text</label>
                    <textarea className="TextSettings-formGroupColumn" name="text" onChange={(e) => this.props.onTextUpdate(e.target.value)} value={this.props.text} />
                </div>
                <div className="TextSettings-formGroup">
                    <label className="TextSettings-formGroupColumn" htmlFor="fontFamily">Font family:</label>
                    <select 
                ...
                <div className="TextSettings-formGroup">
                    <label className="TextSettings-formGroupColumn" htmlFor="fontSize">
                        Font Size: {this.props.settings.fontSize.value}{this.props.settings.fontSize.unit}
                    </label>
                    <input 
                        className="TextSettings-formGroupColumn"
                        name="fontSize" 
                ...
                <div className="TextSettings-formGroup">
                    <label className="TextSettings-formGroupColumn" htmlFor="letterSpacing">
                        Letter spacing: {this.props.settings.letterSpacing.value}{this.props.settings.letterSpacing.unit}
                    </label>
                    <input 
                        className="TextSettings-formGroupColumn"
                        name="letterSpacing" 
                ...
                <div className="TextSettings-formGroup">
                    <label className="TextSettings-formGroupColumn" htmlFor="lineHeight">
                        Line height: {this.props.settings.lineHeight.value}{this.props.settings.lineHeight.unit}
                    </label>
                    <input 
                        className="TextSettings-formGroupColumn"
                        name="lineHeight" 
